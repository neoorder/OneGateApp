    ...
    string CreateDapiInjectionScript()
    {
        return $$"""
            (function () {
                ...
                const methods = ["authenticate", "getAccounts", "pickAddress", "pickContact", "getBalance", "send", "call", "invoke", "makeTransaction", "sign", "signMessage", "relay", "getBlock", "getBlockCount", "getTransaction", "getApplicationLog", "getStorage", "getTokenInfo"];
