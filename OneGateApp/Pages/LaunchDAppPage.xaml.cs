    ...
    string CreateDapiInjectionScript()
    {
        return $$"""
            (function () {
                ...
                const methods = ["authenticate", "getAccounts", "pickAddress", "getBalance", "send", "requestPayment", "call", "invoke", "makeTransaction", "sign", "signMessage", "relay", "getBlock", "getBlockCount", "getTransaction", "getApplicationLog", "getStorage", "getTokenInfo"];
